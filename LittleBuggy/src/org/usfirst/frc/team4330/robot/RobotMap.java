...
public class RobotMap {
	...
	// SpeedControllers
	public static final int RIGHT_BACK_WHEEL = 0;
...
//	public static int MINI_LEFT_WHEEL = 5;
	...
	public static final int MINI_MOTOR_PORT = 5;
	public static final double MINI_WHEEL_SPEED = .2;
	
	// Joysticks
	public static final int JOYSTICK_ONE_LEFT = 1;
	public static final int JOYSTICK_TWO_RIGHT = 2;
