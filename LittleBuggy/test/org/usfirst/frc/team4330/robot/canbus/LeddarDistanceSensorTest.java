...
public class LeddarDistanceSensorTest {
	...
	public void testHappyPathMessage() throws Exception {
		...
		addToReceiveBuffer(testObject.getDistanceMessageId(), new byte[] {48, 117, 125, 60, 14, -2, -1, -5});
		...
		addToReceiveBuffer(testObject.getDistanceMessageId(), new byte[] {1, 0, 0, 20, 0, 0, 0, 0});
		Thread.sleep(100);
